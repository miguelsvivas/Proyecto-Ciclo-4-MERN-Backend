...
const crearVehiculo = async (datosVehiculo, callback) => {
  if (
    ...
    Object.keys(datosVehiculo).includes('description') &&
    Object.keys(datosVehiculo).includes('categoria') &&
    Object.keys(datosVehiculo).includes('cantidad') &&
    Object.keys(datosVehiculo).includes('precio') &&
    Object.keys(datosVehiculo).includes('imagen') 
  ) {
    const baseDeDatos = getDB();
